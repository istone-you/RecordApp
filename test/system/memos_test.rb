...
class MemosTest < ApplicationSystemTestCase
  ...
  test "creating a Memo" do
    ...
    fill_in "Coment", with: @memo.coment
    fill_in "Count", with: @memo.count
    fill_in "Hours", with: @memo.hours
    fill_in "Image", with: @memo.image
    fill_in "Minutes", with: @memo.minutes
    fill_in "Money", with: @memo.money
