...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { coment: @memo.coment, count: @memo.count, hours: @memo.hours, image: @memo.image, minutes: @memo.minutes, money: @memo.money, title: @memo.title, user_id: @memo.user_id } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { coment: @memo.coment, count: @memo.count, hours: @memo.hours, image: @memo.image, minutes: @memo.minutes, money: @memo.money, title: @memo.title, user_id: @memo.user_id } }
